...
if(vngen_event()){
	vngen_char_create_ext("Leutnant Scholle",	spr_scholle_idle, 580, 0, scale_y);
...
if(vngen_event()){
   ...
   if(vngen_option("choice_1")) {
	...
	switch (vngen_get_option("choice_1", true)) {
	      case "opt_organisiert":	global.rich += 2; global.crowd +=1; global.rush +=3; global.scholle +=1; break;
	      case "opt_bauch":			global.scholle += 3; global.rush -=1; global.crowd += 1; break;
	      case "opt_ziele":			global.rich += 3; global.rush += 3; global.crowd += 1; break;
...
if(vngen_event()){
   ...
   if (vngen_option("choice_2")) {
	...
	switch (vngen_get_option("choice_2", true)) {
	      case "opt_ich":			global.rich -= 2; global.crowd -=1; global.rush +=2; global.scholle -=1; break;
...
if (vngen_event()) {
	...
	if(global.investorSelected == 2){
		...
		vngen_char_create_ext("Netz", item_fischernetz_glow, 200,100, scale_prop_x_y);
...
if (vngen_event()) {
	...
	if(global.investorSelected == 3){
		vngen_char_create_ext("Buch", item_anurabuch_glow, 300,100, scale_prop_x_y);
		vngen_char_change_sprite("Dr. Rich Wealth", spr_rich_gluecklich_grey, scale_y);
...
if (vngen_event()) {
	...
	if(global.investorSelected == 1){
		vngen_char_create_ext("Jacke", item_outdoorjacke_glow, 1000,100, scale_prop_x_y);
	...
	if(global.investorSelected == 4){
		...
		vngen_char_create_ext("Multitool", item_multitool_glow, 685,100, scale_prop_x_y);
		vngen_char_change_sprite("Mr. Funding", spr_mr_funding_gluecklich_grey, scale_y);
