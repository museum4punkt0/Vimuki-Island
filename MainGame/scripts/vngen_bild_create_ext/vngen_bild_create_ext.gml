/// @function	vngen_bild_create_ext(name, spr_body,x, y);
/// @param		{string}		name
...
function vngen_bild_create_ext() {
	...
	*/
	...
	var create_char_body_hor_offset  = orig_center;
	var create_char_body_ver_offset  = orig_center;
	var create_char_depth  = 5;
